...
namespace DataService_BpmOnline_CRUD
{
    class Program
    {
        ...
        private static void Delete(string entityName)
        {
            ...
            Guid IdParseResult = TryParseProperty.TryParseGuidProperty(Localize.PropertyId, entityName);
            Console.WriteLine(Localize.Deleting + "...");
            try
            {
                CRUDOperations.DeleteEntity(IdParseResult);
        ...
        private static void ExecuteCommand(string Command)
        {
            switch (Command)
            {
                ...
                case "4":
                    ...
                    break;
                case "5":
                    Console.WriteLine(String.Format(Localize.SelectedCommand, Localize.ReadByGuid));
                    ReadById(Localize.Account);
                    break;
                case "6":
                    Environment.Exit(0);
                    break;
